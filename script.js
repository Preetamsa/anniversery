...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "everyday day I cannot believe how lucky I am to got you baccha ji",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["to have you in my life you make everthing simple for me baccha"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "Your voice makes me calm and your smile makes me happy always",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "I wanted to build our dream together where we both can work toward it",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Each moment i spend with you is precious for me every second",
          "every min and evey hour i want to spend my life with you.",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "Each moment i spend with you is precious for me every second every min and evey hour i want to spend my life with you.",
        canvas.width / 2,
        canvas.height / 2
      );
    }
